            ...
            <div class="row gy-11">
                    ...
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                ...
                                <img src="../assets/images/products/product-01-330x440.jpg"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                ...
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Shield Conditioner</a>
                            </h4>
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Perfecting Facial Oil" previewlistener="true">
                                <img src="../assets/images/products/product-02-330x440.jpg"
                                    data-src="../assets/images/products/product-02-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Perfecting Facial Oil" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute d-flex z-index-2 product-actions  vertical"><a
                                    class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm quick-view sm"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Perfecting Facial Oil</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Enriched Hand &amp; Body Wash" previewlistener="true">
                                <img src="../assets/images/products/product-03-330x440.jpg"
                                    data-src="../assets/images/products/product-03-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Enriched Hand &amp; Body Wash" width="330"
                                    height="440" loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Enriched Hand &amp; Body Wash</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Shield Shampoo" previewlistener="true">
                                <img src="../assets/images/products/product-04-330x440.jpg"
                                    data-src="../assets/images/products/product-04-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Shield Shampoo" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Shield Shampoo</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Enriched Hand Wash" previewlistener="true">
                                <img src="../assets/images/products/product-05-330x440.jpg"
                                    data-src="../assets/images/products/product-05-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Enriched Hand Wash" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Enriched Hand Wash</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                    ...
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block" title="Enriched Duo"
                                previewlistener="true">
                                <img src="../assets/images/products/product-06-330x440.jpg"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Enriched Duo</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                    ...
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block" title="Shield Spray"
                                previewlistener="true">
                                <img src="../assets/images/products/product-07-330x440.jpg"
                                    data-src="../assets/images/products/product-07-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Shield Spray" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute d-flex z-index-2 product-actions  vertical"><a
                                    class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm quick-view sm"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Shield Spray</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Vital Eye Cream" previewlistener="true">
                                <img src="../assets/images/products/product-08-330x440.jpg"
                                    data-src="../assets/images/products/product-08-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Vital Eye Cream" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                                    class="badge badge-product-flash on-sale bg-primary">-26%</span></div>
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Vital Eye Cream</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Supreme Moisture Mask" previewlistener="true">
                                <img src="../assets/images/products/product-09-330x440.jpg"
                                    data-src="../assets/images/products/product-09-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Supreme Moisture Mask" width="330" height="440"
                                    loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                                    class="badge badge-product-flash on-sale bg-primary">-26%</span></div>
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Supreme Moisture Mask</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Supreme Polishing Treatment" previewlistener="true">
                                <img src="../assets/images/products/product-10-330x440.jpg"
                                    data-src="../assets/images/products/product-10-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Supreme Polishing Treatment" width="330"
                                    height="440" loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute d-flex z-index-2 product-actions  vertical"><a
                                    class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm quick-view sm"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Supreme Polishing Treatment</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Scalp Moisturizing Cream" previewlistener="true">
                                <img src="../assets/images/products/product-11-330x440.jpg"
                                    data-src="../assets/images/products/product-11-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Scalp Moisturizing Cream" width="330"
                                    height="440" loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute d-flex z-index-2 product-actions  vertical"><a
                                    class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm quick-view sm"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Scalp Moisturizing Cream</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                ...
                <div class="col-sm-6  col-lg-4 col-xl-3">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated"
                        ...
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="../shop/product-details-v1.html" class="hover-zoom-in d-block"
                                title="Natural Coconut Cleansing Oil" previewlistener="true">
                                <img src="../assets/images/products/product-12-330x440.jpg"
                                    data-src="../assets/images/products/product-12-330x440.jpg"
                                    class="img-fluid w-100 loaded" alt="Natural Coconut Cleansing Oil" width="330"
                                    height="440" loading="lazy" data-ll-status="loaded">
                            </a>
                            <div class="position-absolute product-flash z-index-2 "><span
                                    class="badge badge-product-flash on-sale bg-primary">-26%</span></div>
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4
                                class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="../shop/product-details-v1.html"
                                    previewlistener="true">Natural Coconut Cleansing Oil</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                                    <div class="empty-stars">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="cat_skin-care" class="collapse show" data-bs-parent="#widget_product_category">
                                    <ul class="navbar-nav nav-submenu ps-8">
                                        ...
                                        <li class="nav-item">
                                            <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                href="#"><span class="text-hover-underline">Face Oils</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                        ...
                                        <li class="nav-item">
                                            <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                href="#"><span class="text-hover-underline">Eye Cream</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
