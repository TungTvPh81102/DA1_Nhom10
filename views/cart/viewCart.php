                    ...
                    <tr class="position-relative">
                        <th scope="row" class="pe-5 ps-8 py-7 shop-product">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6 me-7">
                                    <img src="../assets/images/products/product-03-75x100.jpg" data-src="../assets/images/products/product-03-75x100.jpg" class="loaded" width="75" height="100" alt="Natural Coconut Cleansing Oil" loading="lazy" data-ll-status="loaded">
                                </div>
                                <div class="">
                        ...
                        <td class="align-middle">
                            <div class="input-group position-relative shop-quantity">
                                ...
                                <input name="number[]" type="number" class="form-control form-control-sm px-10 py-4 fs-6 text-center border-0" value="1" required="">
                    ...
                    <tr class="position-relative">
                        <th scope="row" class="pe-5 ps-8 py-7 shop-product">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6 me-7">
                                    <img src="../assets/images/products/product-06-75x100.jpg" data-src="../assets/images/products/product-06-75x100.jpg" class="loaded" width="75" height="100" alt="Natural Coconut Cleansing Oil" loading="lazy" data-ll-status="loaded">
                                </div>
                                <div class="">
            ...
            <div class="col-lg-4 pt-lg-0 pt-11">
                <div class="card border-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.1)">
                    ...
                    <div class="card-footer bg-transparent px-0 pt-5 pb-7 mx-9">
                        ...
                        <a href="../shop/checkout.html" class="btn w-100 btn-dark btn-hover-bg-primary btn-hover-border-primary" title="Check Out" previewlistener="true">Check Out</a>
                    </div>
                </div>
            </div>
        </div>
