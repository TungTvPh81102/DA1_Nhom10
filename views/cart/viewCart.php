                ...
                <tbody>
                    ...
                    <tr class="position-relative">
                        ...
                        <td class="align-middle text-end pe-8">
                            <a onclick="return confirm('Bạn có muốn xóa sản phẩm: <?= $item['name'] ?> không ?')"
                                href="<?= BASE_URL ?>?action=cart-del&productID=<?= $item['id'] ?>&sizeID=<?= $item['size'] ?>&colorID=<?= $item['color'] ?>"
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-end pt-5 pb-10 position-relative bg-body right pe-0">
                            <a href="<?= BASE_URL ?>?action=view-cart" value="Update Cart"
                ...
                <div class="card border-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.1)">
                    ...
                    <div class="card-body px-9 pt-6">
                        <div class="d-flex align-items-center justify-content-between mb-5">
                            <span>Total: </span>
                            <span
                                class="d-block ml-auto text-body-emphasis fw-bold"><?= number_format($total, 0) . ' đ'  ?></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <?php if ($_SESSION['coupon']['condition'] == 1) {
                                    ?>
                            <span
                                class="d-block ml-auto text-body-emphasis fw-bold"><?= $_SESSION['coupon']['number'] . '%' ?></span>
                            <?php } else if ($_SESSION['coupon']['condition'] == 2) {
                                    ?>
                            <span
                                class="d-block ml-auto text-body-emphasis fw-bold">-<?= number_format($_SESSION['coupon']['number'], 0) . ' đ' ?></span>
                            <?php } ?>
                        </div>
                        <?php if ($_SESSION['coupon']['condition'] == 1) {
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-5">
                            <span>Discount:</span>
                            <span
                                class="d-block ml-auto text-body-emphasis fw-bold">-<?= number_format($discount, 0) . 'đ' ?></span>
                        </div>
                        <?php } ?>
                    </div>
                    <div class="card-footer bg-transparent px-0 pt-5 pb-7 mx-9">
                        <div class="d-flex align-items-center justify-content-between fw-bold mb-7">
                            ...
                            <span
                                class="d-block ml-auto text-body-emphasis fs-4 fw-bold"><?= calculator_total_coupon($flag = true), 'đ' ?></span>
                        </div>
