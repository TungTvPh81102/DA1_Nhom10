                ...
                <div class="row">
                    <div class="col-md-6 pe-13">
                        <div class="position-relative">
                            ...
                            <div id="slider"
                                ...
                                <a href="<?= BASE_URL ?>assets/client/images/shop/product-gallery-05.jpg"
                                    data-gallery="gallery1"><img src="#"
                                        data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-05.jpg"
                                        class="h-auto lazy-image" width="540" height="720" alt /></a>
                                <a href="<?= BASE_URL ?>assets/client/images/shop/product-gallery-06.jpg"
                                    data-gallery="gallery1"><img src="#"
                                        data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-06.jpg"
                                        class="h-auto lazy-image" width="540" height="720" alt /></a>
                                <a href="<?= BASE_URL ?>assets/client/images/shop/product-gallery-07.jpg"
                                    data-gallery="gallery1"><img src="#"
                                        data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-07.jpg"
                                        class="h-auto lazy-image" width="540" height="720" alt /></a>
                                <a href="<?= BASE_URL ?>assets/client/images/shop/product-gallery-08.jpg"
                                    data-gallery="gallery1"><img src="#"
                                        data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-08.jpg"
                                        class="h-auto lazy-image" width="540" height="720" alt /></a>
                            </div>
                        </div>
                        <div class="mt-6">
                            <div id="slider-thumb" class="slick-slider slick-slider-thumb ps-1 ms-n3 me-n4"
                                ...
                                <img src="#"
                                    data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-05-154x205.jpg"
                                    class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100" alt />
                                <img src="#"
                                    data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-06-154x205.jpg"
                                    class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100" alt />
                                <img src="#"
                                    data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-07-154x205.jpg"
                                    class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100" alt />
                                <img src="#"
                                    data-src="./<?= BASE_URL ?>assets/client/images/shop/product-gallery-08-154x205.jpg"
                                    class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100" alt />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 pt-md-0 pt-10">
                        ...
                        <div class="card border-0 bg-body-tertiary rounded text-center mt-7">
                            <div class="pt-8 px-5">
                                <img class="img-fluid" src="<?= BASE_URL ?>assets/client/images/shop/product-info-2.png"
