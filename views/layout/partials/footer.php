            ...
            <div class="col-lg-3">
                <div class="footer-widget footer-about">
                    ...
                    <div class="footer-contact-actions">
                        ...
                        <div class="footer-action"><span>Email : </span><a href="#"> <span class="__cf_email__" data-cfemail="761f18101936130e171b061a135815191b">[email&#160;protected]</span></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-7">
                    <div class="footer-bottom-paymant-option d-flex align-items-center justify-content-end flex-wrap">
                        ...
                        <ul class="payment-options d-flex">
                            <li><img src="<?= BASE_URL ?>assets/client/images/payment/payment-1.png" alt></li>
                            <li><img src="<?= BASE_URL ?>assets/client/images/payment/payment-2.png" alt></li>
                            <li><img src="<?= BASE_URL ?>assets/client/images/payment/payment-3.png" alt></li>
                            <li><img src="<?= BASE_URL ?>assets/client/images/payment/payment-2.png" alt></li>
                        </ul>
                    </div>
                </div>
