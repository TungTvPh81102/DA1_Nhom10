            ...
            <div class="row">
                <div
                    ...
                    <div class="main-logo d-flex justify-content-between align-items-center">
                        <a href="index.html">
                            <img src="<?= BASE_URL ?>assets/client/images/Logo.png" alt>
                        </a>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 d-flex justify-content-center">
                    <nav class="main-nav">
                        <div class="inner-logo">
                            <a href="index.html"><img src="<?= BASE_URL ?>assets/client/images/logo-w.png" alt></a>
                        </div>
                        <ul class="nav-item-list">
                            <li class="has-child-menu">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="https://demo-egenslab.b-cdn.net/html/eg-shop-fashion/v2/index.html">EG
                                            Shop Fashion 2</a></li>
                                    <li><a href="https://demo-egenslab.b-cdn.net/html/eg-shop-fashion/v3/index.html">EG
                                            Shop Fashion 3</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="inner-top">
                            <div class="inner-mail">
                                ...
                                <a href="mail.html"><span class="__cf_email__"
                                        data-cfemail="aec7c0c8c1dddbdedec1dcdaeecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</span></a>
                            </div>
                            <div class="inner-tel">
