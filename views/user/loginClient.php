                ...
                <div class="breadcrumb-bg d-flex justify-content-center align-items-center">
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <ul class="page-switcher d-flex ">
                            <li><a href="index.html" previewlistener="true">Home</a> <i class="flaticon-arrow-pointing-to-right"></i></li>
                            <li>Login</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="reg-login-forms">
                    ...
                    <div class="reg-social-login">
                        ...
                        <ul class="social-login-options">
                            <li><a href="#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign up
                                    whit facebook</a></li>
