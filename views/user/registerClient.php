        ...
        <div class="col-lg-5 col-md-8 mx-auto">
            <form class="" method="post">
                ...
                <div class="mb-6">
                    ...
                    <input name="first_name" id="first_name" type="text" class="form-control mb-3"
                        placeholder="First name"
                        value="<?= isset($_SESSION['data']) ? $_SESSION['data']['first_name'] : null ?>" required="">
                    <span class="text-danger"><?= formErrors('first_name', $errorsMess) ?></span>
                </div>
                <div class="mb-6">
                    <label for="last_name" class="visually-hidden">Last name</label>
                    <input name="last_name" id="last_name" type="text" class="form-control mb-3" placeholder="Last name"
                        value="<?= isset($_SESSION['data']) ? $_SESSION['data']['last_name'] : null ?>" required="">
                ...
                <div class="mb-6">
                    ...
                    <input name="email" id="email" type="email" class="form-control mb-3" placeholder="Your email"
                        value="<?= isset($_SESSION['data']) ? $_SESSION['data']['email'] : null ?>" required="">
                ...
                <div class="mb-7">
                    ...
                    <input name="confirm_password" id="confirm_password" type="password" class="form-control mb-3"
                ...
                <div class="form-check mb-7">
                    ...
                    <label class="form-check-label text-secondary" for="agree_terms">
                        Yes, I agree with Grace <a href="#" class="text-decoration-underline">Privacy Policy</a> and <a
                            href="#" class="text-decoration-underline">Terms of Use</a>
                    </label>
                </div>
