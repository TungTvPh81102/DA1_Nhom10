                ...
                <div class="checkout">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="full-name" name="full_name"
                                ...
                                value="<?= isset($_SESSION['user']) ? $_SESSION['user']['first_name'] . ' ' . $_SESSION['user']['last_name'] : null ?>"
                                required="">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-md-0 mb-7">
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email"
                                    value="<?= isset($_SESSION['user']) ? $_SESSION['user']['email'] : null ?>"
                                    required="">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="phone" name="phone"
                                    ...
                                    value="<?= isset($_SESSION['user']) ? $_SESSION['user']['phone_number'] : null ?>"
                                    required="">
                    ...
                    <div class="mb-7">
                        ...
                        <input class="form-control" type="text" name="zipcode" id="" placeholder="Nhập mã bưu điện"
                            value="<?= isset($_SESSION['data']) ? $_SESSION['data']['zipcode'] : null ?>">
                    ...
                    <div class="mb-7">
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="province" id=""
                                ...
                                value="<?= isset($_SESSION['data']) ? $_SESSION['data']['province'] : null ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="district" id=""
                                ...
                                value="<?= isset($_SESSION['data']) ? $_SESSION['data']['district'] : null ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="ward" id="" placeholder="Nhập phường xã"
                                value="<?= isset($_SESSION['data']) ? $_SESSION['data']['ward'] : null ?>">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="tab-content mt-7">
                            <div class="tab-pane fade active show d-flex" id="paypal-tab" role="tabpanel">
                                ...
                                <div style="margin-right: 20px;" class="">
                                    <input type="radio" name="paymethod" id="vnpay" value="1"> Thanh toán Online
                                </div>
                            </div>
                        </div>
                    </div>
