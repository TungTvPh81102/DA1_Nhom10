                ...
                <div class="checkout">
                    ...
                    <div class="mb-7">
                        ...
                        <input class="form-control" type="text" name="zipcode" id="" placeholder="Nhập mã bưu điện"
                            value="<?= isset($_SESSION['dataOrder']) ? $_SESSION['dataOrder']['zipcode'] : null ?>">
                    ...
                    <div class="mb-7">
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="province" id=""
                                ...
                                value="<?= isset($_SESSION['dataOrder']) ? $_SESSION['dataOrder']['province'] : null ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="district" id=""
                                ...
                                value="<?= isset($_SESSION['dataOrder']) ? $_SESSION['dataOrder']['district'] : null ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control mb-5" type="text" name="ward" id="" placeholder="Nhập phường xã"
                                value="<?= isset($_SESSION['dataOrder']) ? $_SESSION['dataOrder']['ward'] : null ?>">
