...
<section class="container pb-14 pb-lg-19" data-animated-id="2">
    ...
    <form class="pt-12" action="<?= BASE_URL ?>?action=order-purchase" method="post">
        <div class="row">
                        ...
                        <ul class="list-inline d-flex justify-content-start mb-0">
                            ...
                            <li class="list-inline-item me-4 fw-semibold">
                                <input value="0" type="radio" id="0" name="paymethod" class="product-info-size d-none"
                                    checked>
                                <label for="0" class="fs-14px p-4 d-block rounded text-decoration-none border"
                                    data-var="0">Thanh toán khi nhận hàng</label>
                            </li>
                            <input value="1" type="radio" id="1" name="redirect" class="product-info-size d-none">
                            <label for="1" class="fs-14px p-4 d-block rounded text-decoration-none border"
                                data-var="1">Thanh toán Online</label>
                            </li>
                        </ul>
