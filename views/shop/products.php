                    ...
                    <ul class="pagination m-0">
                        ...
                        <?php for ($pageItem = 1; $pageItem <= $maxPage; $pageItem++) { ?>
                            <li class="page-item <?= ($pageItem == $page) ? 'active' : '' ?>">
                                <a class="page-link" href="<?= BASE_URL ?>?action=products&page=<?= $pageItem ?>"><?= $pageItem ?></a>
                            </li>
                        <?php } ?>
                        <li class="page-item">
                        ...
                        <ul class="navbar-nav navbar-nav-cate" id="widget_product_price">
                            <li class="nav-item">
                                <a href="#" title="Skin care" class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center text-uppercase fs-14px fw-semibold letter-spacing-5 active">
                                    ...
                                    <span data-bs-toggle="collapse" data-bs-target="#cat_skin-price" class="caret flex-grow-1 d-flex align-items-center justify-content-end collapsed"><svg class="icon">
                                            <use xlink:href="#icon-plus"></use>
                                        </svg></span> </a>
                                <div id="cat_skin-price" class="collapse show" data-bs-parent="#widget_product_brand">
                                    <ul class="navbar-nav nav-submenu ps-8">
                                        <li class="nav-item">
                                            <a href="<?= BASE_URL ?>?action=products&price-range=1" class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">Smaller 100.000đ</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?= BASE_URL ?>?action=products&price-range=2" class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">From 100.000đ To 300.000đ</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?= BASE_URL ?>?action=products&price-range=3" class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">Larger 300.000đ</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
