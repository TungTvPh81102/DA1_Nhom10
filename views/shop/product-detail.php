                    ...
                    <ul class="list-inline d-flex justify-content-start mb-0">
                        ...
                        ?>
                            <li class="list-inline-item me-4 fw-semibold">
                                <input value="<?= $value ?>" type="radio" id=<?= $value ?> name="size_id" class="product-info-size d-none" <?= ($key === array_key_first($sizes)) ? 'checked' : '' ?>>
                        ...
                        <ul class="list-inline d-flex justify-content-start mb-0">
                            ...
                            ?>
                                <li class="list-inline-item list-color-product selected p-3">
                                    <input value="<?= $value ?>" type="radio" id="<?= $value ?>" name="color_id" class="product-info-size d-none" <?= ($key === array_key_first($colors)) ? 'checked' : '' ?>>
