                    ...
                    <ul class="list-inline d-flex justify-content-start mb-0">
                        <?php foreach ($sizes as $key => $value) : ?>
                            <li class="list-inline-item me-4 fw-semibold">
                                <input value="<?= $key ?>" type="radio" id="<?= $key ?>" name="size_id" class="product-info-size d-none">
                                <label for="<?= $key ?>" class="fs-14px p-4 d-block rounded text-decoration-none border" data-var="<?= $value ?>"><?= $value ?></label>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                        ...
                        <ul class="list-inline d-flex justify-content-start mb-0">
                            <?php foreach ($colors as $key => $value) : ?>
                                <li class="list-inline-item list-color-product selected p-3">
                                    <input value="<?= $key ?>" type="radio" id="<?= $key ?>" name="color_id" class="product-info-size d-none" checked="">
                                    <label style="background-color: <?= $value ?>;" for="<?= $key ?>" class="d-block color-item border" data-var="<?= $value ?>"></label>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="card card-product grid-2 bg-transparent border-0 animate__fadeInUp animate__animated" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            ...
                            </div><a href="#" class="btn btn-add-to-cart btn-dark btn-hover-bg-primary btn-hover-border-primary position-absolute z-index-2 text-nowrap btn-sm px-6 py-3 lh-2">Add
                                To Cart</a>
                        </figure>
                    ...
                    <div class="card-body px-4 py-10">
                        ...
                        <div class="mb-8">
                            <div class="d-flex align-items-center justify-content-center mb-5">
                                ...
                                <div class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 78%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-5">
                                ...
                                <div class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 17%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-5">
                                ...
                                <div class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 3%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-5">
                                ...
                                <div class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 2%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-5">
                                ...
                                <div class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class=" mt-12">
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <div class="d-flex justify-content-start align-items-center mb-5">
                        <img src="../assets/images/others/single-product-01.png" data-src="../assets/images/others/single-product-01.png" class="me-6 rounded-circle loaded" width="60" height="60" alt="Avatar" loading="lazy" data-ll-status="loaded">
                        <div class="">
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <div class="d-flex justify-content-start align-items-center mb-5">
                        <img src="../assets/images/others/product-review-avatar-01.jpg" data-src="../assets/images/others/product-review-avatar-01.jpg" class="me-6 rounded-circle loaded" width="60" height="60" alt="Avatar" loading="lazy" data-ll-status="loaded">
                        <div class="">
                            <h5 class="mt-0 mb-4 fs-14px text-uppercase ls-1">JENNIFER C.</h5>
                    ...
                    <div class="mb-10"><img src="../assets/images/others/single-product-03.jpg" data-src="../assets/images/others/single-product-03.jpg" class="mx-3 w-auto loaded" alt="" loading="lazy" data-ll-status="loaded">
                        <img src="../assets/images/others/single-product-02.jpg" data-src="../assets/images/others/single-product-02.jpg" class="mx-3 w-auto loaded" alt="" loading="lazy" data-ll-status="loaded">
                    </div>
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="#" class="fs-14px mb-0 text-secondary">Was This Review Helpful?</a>
                        <p class="mb-0 ms-7 text-body-emphasis">
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <div class="d-flex justify-content-start align-items-center mb-5">
                        <img src="../assets/images/others/product-review-avatar-03.jpg" data-src="../assets/images/others/product-review-avatar-03.jpg" class="me-6 rounded-circle loaded" width="60" height="60" alt="Avatar" loading="lazy" data-ll-status="loaded">
                        <div class="">
                            <h5 class="mt-0 mb-4 fs-14px text-uppercase ls-1">JENNIFER C.</h5>
                            <p class="mb-0">/ Orlando, FL</p>
                        </div>
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <div class="d-flex justify-content-start align-items-center mb-5">
                        <img src="../assets/images/others/product-review-avatar-02.jpg" data-src="../assets/images/others/product-review-avatar-02.jpg" class="me-6 rounded-circle loaded" width="60" height="60" alt="Avatar" loading="lazy" data-ll-status="loaded">
                        <div class="">
                            <h5 class="mt-0 mb-4 fs-14px text-uppercase ls-1">JENNIFER C.</h5>
                            <p class="mb-0">/ Orlando, FL</p>
                        </div>
