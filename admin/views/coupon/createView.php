                            ...
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="condition" class="form-select mb-3">
                                        ...
                                        <option
                                            <?= isset($_SESSION['data']) &&  $_SESSION['data']['condition'] == 1 ? 'selected' : null ?>
                                            value="1">Giảm theo phần trăm</option>
                                        <option
                                            <?= isset($_SESSION['data']) &&  $_SESSION['data']['condition'] == 2 ? 'selected' : null ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="number" id="number" type="text" class="form-control mb-3"
                                        ...
                                        value="<?= isset($_SESSION['data']) ? $_SESSION['data']['number'] : null  ?>">
