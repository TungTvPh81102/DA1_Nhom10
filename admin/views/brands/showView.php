                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="brandname" type="text" class="form-control mb-3" placeholder="Nhập tên thương hiệu" value="<?= $brand['name'] ?>" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select mb-3" disabled>
                                        ...
                                        <option <?= !$brand['status'] ? 'selected' : null ?> value="0">Inactive</option>
                                    </select>
