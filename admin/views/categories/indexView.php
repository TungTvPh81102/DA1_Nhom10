                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $category['id'] ?></td>
                                <td><?= $category['name'] ?></td>
                                <td><?= $category['parent_id'] ?  '<span class="btn btn-success btn-sm waves-effect waves-light">Danh mục con</span>' : ' <span class="btn btn-primary btn-sm waves-effect waves-light">Danh mục chính</span>' ?>
                                </td>
                                ...
                                <td>
                                    <a href="<?= BASE_URL_ADMIN ?>?action=category-detail&id=<?= $category['id'] ?>"
                                        class="btn btn-info">
                                        Chi tiết
                                    </a>
                                    <a href="<?= BASE_URL_ADMIN ?>?action=category-update&id=<?= $category['id'] ?>"
                                        class="btn btn-warning">
                                        Sửa
                                    </a>
                                    <a onclick="return confirm('Bạn có chắc muốn xóa danh mục: <?= $category['name'] ?> không?')"
                                        href="<?= BASE_URL_ADMIN ?>?action=category-delete&id=<?= $category['id'] ?>"
